                                        ...
                                        @foreach($students as $student)
                                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    ...
                                                    <td class="px-2 py-3 text-center">
                                                        <a href="tel:+2{{ $student->phone }}" class="inline-flex items-center text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                                                    ...
                                                    <td class="px-2 py-3">
                                                        <div class="flex items-center justify-center gap-2">
                                                            <a href="{{ route('students.edit', $student->id) }}" class="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-white hover:bg-blue-500 dark:text-gray-400 dark:hover:bg-blue-600 rounded-full transition-all duration-200" title="تعديل">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                                </svg>
                                                            </a>
                                                            <form action="{{ route('students.destroy', $student->id) }}" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا الطالب؟')">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            <td colspan="6" class="py-16 text-center">
                                                <div class="flex flex-col items-center justify-center w-full">
                                                    <div class="text-center">
                                                        ...
                                                        <p class="text-sm text-gray-500 dark:text-gray-400">لم يتم العثور على أي طلاب مسجلين في النظام.</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center justify-between">
                                        <div class="mb-4 sm:mb-0">
                                            <p class="text-sm text-gray-400">
                                                عرض
                                                <span class="font-medium text-white">{{ $students->firstItem() }}</span>
                                                إلى
                                                <span class="font-medium text-white">{{ $students->lastItem() }}</span>
                                                من
